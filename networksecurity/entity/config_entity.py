...
class DataValidationConfig:
    def __init__(self,training_pipeline_config:TrainingPipelineConfig):
        ...
        self.drift_report_file_path:str = os.path.join(
            ...
            tp.DATA_VALIDATION_DRIFT_REPORT_DIR,tp.DATA_VALIDATION_DRIFT_REPORT_FILE_NAME
        )
...
class DataTransformationConfig:
     def __init__(self,training_pipeline_config:TrainingPipelineConfig):
        ...
        self.transformed_test_file_path: str = os.path.join(self.data_transformation_dir,  tp.DATA_TRANSFORMATION_TRANSFORMED_DATA_DIR,
            tp.TEST_FILE_NAME.replace("csv", "npy"), )
        self.transformed_object_file_path: str = os.path.join( self.data_transformation_dir, tp.DATA_TRANSFORMATION_TRANSFORMED_OBJECT_DIR,
...
class ModelTrainerConfig:
    def __init__(self,training_pipeline_config:TrainingPipelineConfig):
        ...
        self.trained_model_file_path: str = os.path.join(
            self.model_trainer_dir, tp.MODEL_TRAINER_TRAINED_MODEL_DIR, 
            tp.MODEL_FILE_NAME
        )
        self.expected_accuracy: float = tp.MODEL_TRAINER_EXPECTED_SCORE
        self.overfitting_underfitting_threshold = tp.MODEL_TRAINER_OVER_FITTING_UNDER_FITTING_THRESHOLD